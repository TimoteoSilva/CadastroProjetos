        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContatosJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StatusProjetoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Statuses", x => x.StatusProjetoId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjetoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Ordem = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
                    ClienteId = table.Column<int>(type: "int", nullable: false),
                    ...
                    StatusProjetoId = table.Column<int>(type: "int", nullable: false),
                    ResponsavelUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projetos_Statuses_StatusProjetoId",
                        column: x => x.StatusProjetoId,
                        principalTable: "Statuses",
                        principalColumn: "StatusProjetoId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistoricoProjetoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjetoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Historicos", x => x.HistoricoProjetoId);
                    table.ForeignKey(
                        name: "FK_Historicos_Projetos_ProjetoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clientes_RazaoSocial",
                table: "Clientes",
                column: "RazaoSocial");

            migrationBuilder.CreateIndex(
                name: "IX_Historicos_ProjetoId",
                table: "Historicos",
                column: "ProjetoId");

            migrationBuilder.CreateIndex(
                name: "IX_Projetos_ClienteId_StatusProjetoId",
                table: "Projetos",
                columns: new[] { "ClienteId", "StatusProjetoId" });

            migrationBuilder.CreateIndex(
                name: "IX_Projetos_StatusProjetoId",
                table: "Projetos",
                column: "StatusProjetoId");

            migrationBuilder.CreateIndex(
                name: "IX_Statuses_Ordem",
                table: "Statuses",
                column: "Ordem");
        }
